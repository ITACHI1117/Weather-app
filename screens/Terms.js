    ...
    <SafeAreaView style={styles.trans}>
      <ScrollView style={styles.box}>
        <View style={styles.center}>
          ...
          <Text style={styles.emoji}>Terms and Services</Text>
          <Text
            style={{
              color: "black",
              fontSize: 16,
          ...
          >
            Terms and Conditions for Weather Terms and Conditions Last updated:
            August 27, 2022 Please read these terms and conditions carefully
            before using Our Service. Interpretation and Definitions
            ...
            appear in singular or in plural. Definitions For the purposes of
            these Terms and Conditions: Application means the software program
            provided by the Company downloaded by You on any electronic device,
            named Weather Application Store means the digital distribution
            ...
            managing authority. Country refers to: Nigeria Company (referred to
            as either "the Company", "We", "Us" or "Our" in this Agreement)
            refers to Weather. Device means any device that can access the
            Service such as a computer, a cellphone or a digital tablet. Service
            refers to the Application. Terms and Conditions (also referred as
            ...
            the help of the TermsFeed Terms and Conditions Generator.
            ...
            Our Service. Links to Other Websites Our Service may contain links
            ...
            services that You visit. Termination We may terminate or suspend
            Your access immediately, without prior notice or liability, for any
            ...
            will be limited to the greatest extent permitted by law. "AS IS" and
            ...
            resident in. United States Legal Compliance You represent and
            warrant that (i) You are not located in a country that is subject to
            the United States government embargo, or that has been designated by
            the United States government as a "terrorist supporting" country,
            and (ii) You are not listed on any United States government list of
            prohibited or restricted parties. Severability and Waiver
            ...
            provisions will continue in full force and effect. Waiver Except as
            ...
            waiver of any subsequent breach. Translation Interpretation These
            ...
            text shall prevail in the case of a dispute. Changes to These Terms
            and Conditions We reserve the right, at Our sole discretion, to
            ...
            the new terms, in whole or in part, please stop using the website
            and the Service. Contact Us If you have any questions about these
            Terms and Conditions, You can contact us: By email:
            ajoguJoseph0317@gmail.com By phone number: 08146821934 Generated
            using TermsFeed Privacy Policy Generator
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
